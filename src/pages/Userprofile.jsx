...
//       <div className="min-h-screen bg-[#55D6C2] p-8 font-sanchez">
//         <div className="flex flex-wrap gap-6">
//           <div className="bg-white p-6 rounded-lg shadow w-[480px] h-[450px]">
//             <div className=" text-gray-500 cursor-pointer ml-96 ">
//               <img src={edit} alt="tst" className="w-[25px] h-[25px]"></img>
//             </div>
//             <div className="flex flex-col items-center gap-4">
//               <img src={user} alt="text" className="w-[200px]"></img>
//               <div className="mr-28 mt-6 space-y-1 text-start">
//                 <p>Username:</p>
//                 <p>Contact Number:</p>
//                 <p>Email:</p>
...
//           {/* Feedback Card */}
//           <div className="bg-white p-6 rounded-lg shadow w-[300px] h-[200px]">
//             <h3 className=" mb-2 text-sm text-center">Give Your Feedback</h3>
//             <input
//               placeholder="[Lorem Ipsum]"
//               className="w-full border border-gray-400 rounded p-2 text-sm mb-3"
